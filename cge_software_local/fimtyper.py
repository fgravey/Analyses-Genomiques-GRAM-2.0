...
def fimtyper(liste,fasta_dir,outputdir,fasta_extension):
    #### unchanging path
    ...
    # Information
    print("##################################################")
    print("############## {} ###########".format('Launching Fimtyper Script'))
    print("##################################################")
    ...
    for nom in travail:
        ...
        #Launching fimtyper perl script
...
if __name__ == "__main__":
    ...
    ###############################################################################
    # Launching Function
    fimtyper(liste,fasta_dir,outputdir,fasta_extension)
